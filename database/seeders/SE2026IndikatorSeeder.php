...
class SE2026IndikatorSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // ====== SESUAIKAN DI SINI ======
        $table = 'se2026_indikator';                // nama tabel di database
        $path  = database_path('seeders/data/SE2026_Indikator.csv'); // lokasi CSV
        // =================================
