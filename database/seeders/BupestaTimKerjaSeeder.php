...
class BupestaTimKerjaSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // ====== SESUAIKAN DI SINI ======
        $table = 'bupesta_timkerja';                // nama tabel di database
        $path  = database_path('seeders/data/Bupesta_TimKerja.csv'); // lokasi CSV
        // =================================
