...
class JazirahIndikatorSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // ====== SESUAIKAN DI SINI ======
        $table = 'jazirah2_indikator';                // nama tabel di database
        $path  = database_path('seeders/data/rencana_kerjas.csv'); // lokasi CSV
        // =================================
