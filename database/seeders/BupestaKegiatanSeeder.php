...
class BupestaKegiatanSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // ====== SESUAIKAN DI SINI ======
        $table = 'bupesta_kegiatan';                // nama tabel di database
        $path  = database_path('seeders/data/Bupesta_Kegiatan.csv'); // lokasi CSV
        // =================================
