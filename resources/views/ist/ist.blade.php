                                ...
                                <div class="modal-content modal-xxl">
                                    ...
                                    <div class="modal-body" style="background: #f8fafc; padding: 20px 25px;">
                                        @if (!empty($monitoringData))
                                            ...
                                            <div
                                                style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 25px; border-bottom: 2px solid #cbd5e1; padding-bottom: 0; flex-wrap: wrap; gap: 10px;">
                                                ...
                                                <div id="mon-download-btn-wrapper" style="padding-bottom: 8px;">
                                                    <button type="button" id="btn-download-mon-1_1"
                                                        onclick="downloadMonitoringImage('mon-tab-1_1', 'monitoring-tahap-1-1')"
                                                        style="background: linear-gradient(135deg,#6366f1,#4f46e5); color:#fff; border:none; padding:8px 16px; border-radius:8px; font-size:12px; font-weight:600; cursor:pointer; display:inline-flex; align-items:center; gap:6px; box-shadow:0 2px 8px rgba(99,102,241,0.35); transition:all 0.2s;">
                                                        <i class="fa-solid fa-image"></i> Download Gambar
                                                    </button>
                                                    <button type="button" id="btn-download-mon-1_2"
                                                        onclick="downloadMonitoringImage('mon-tab-1_2', 'monitoring-tahap-1-2')"
                                                        style="background: linear-gradient(135deg,#6366f1,#4f46e5); color:#fff; border:none; padding:8px 16px; border-radius:8px; font-size:12px; font-weight:600; cursor:pointer; display:none; align-items:center; gap:6px; box-shadow:0 2px 8px rgba(99,102,241,0.35); transition:all 0.2s;">
                                                        <i class="fa-solid fa-image"></i> Download Gambar
                                                    </button>
                                                </div>
                                            </div>
                                            ...
                                            <div id="mon-tab-1_1"
                                                ...
                                                <div id="rekap-partisipasi-wrapper">
                                                    <h4 style="margin-bottom: 15px; color: #1e293b;"><i
                                                            class="fa-solid fa-chart-bar"></i> Rekapitulasi Partisipasi
                                                    </h4>
                                                    <div
                                                        ...
                                                        <table class="ist-table" id="tbl-mon-1_1">
                                                            <thead>
                                                                <tr>
                                                                    <th data-sort-col="0" data-sort-type="string"
                                                                        style="cursor:pointer; user-select:none;">Satuan
                                                                        Kerja <span class="sort-icon">⇅</span></th>
                                                                    <th data-sort-col="1" data-sort-type="number"
                                                                        style="text-align: center; cursor:pointer; user-select:none;">
                                                                        Total Pegawai <span class="sort-icon">⇅</span>
                                                                    </th>
                                                                    <th data-sort-col="2" data-sort-type="number"
                                                                        style="text-align: center; color: #10b981; cursor:pointer; user-select:none;">
                                                                        Sudah Menilai <span class="sort-icon">⇅</span>
                                                                    </th>
                                                                    <th data-sort-col="3" data-sort-type="number"
                                                                        style="text-align: center; color: #ef4444; cursor:pointer; user-select:none;">
                                                                        Belum Menilai <span class="sort-icon">⇅</span>
                                                                    </th>
                                                                    <th data-sort-col="4" data-sort-type="number"
                                                                        style="cursor:pointer; user-select:none;"
                                                                        width="25%">Progress Partisipasi <span
...
@endforeach
                                                        ...
                                                        <button type="button"
                                                            ...
                                                            <i class="fa-brands fa-whatsapp"
                                                                style="font-size: 14px; margin-right: 4px;"></i> Copy
                                                            WA
                                                        </button>
                                                    </div>
                                                @empty
                                            ...
                                            <div id="mon-tab-1_2"
                                                ...
                                                <div
                                                    ...
                                                    <table class="ist-table" id="tbl-mon-1_2"
                                                        style="min-width: 750px;">
                                                        <thead>
                                                            <tr>
                                                                <th data-sort-col="0" data-sort-type="string"
                                                                    style="cursor:pointer; user-select:none; min-width:160px;">
                                                                    Satuan Kerja <span class="sort-icon">⇅</span></th>
                                                                <th data-sort-col="1" data-sort-type="string"
                                                                    style="text-align: center; cursor:pointer; user-select:none; white-space:nowrap; width:130px;">
                                                                    Status Penetapan <span class="sort-icon">⇅</span>
                                                                </th>
                                                                <th data-sort-col="2" data-sort-type="string"
                                                                    style="cursor:pointer; user-select:none; min-width:140px;">
                                                                    Nama Kandidat <span class="sort-icon">⇅</span></th>
                                                                <th data-sort-col="3" data-sort-type="string"
                                                                    style="text-align: center; cursor:pointer; user-select:none; white-space:nowrap; width:100px;">
                                                                    Dokumen SK <span class="sort-icon">⇅</span></th>
                                                                <th data-sort-col="4" data-sort-type="string"
                                                                    style="text-align: center; cursor:pointer; user-select:none; white-space:nowrap; width:130px;">
                                                                    Status Validasi SK <span class="sort-icon">⇅</span>
                                                                </th>
                                                        ...
                                                        <tbody>
                                                            @foreach ($monitoringData['tahap1_2'] as $satker => $dataMon2)
                                                                <tr>
                                                                    <td data-val="{{ $satker }}"
                                                                        style="font-weight: 600; color: #334155; font-size: 12px;">
                                                                        {{ $satker }}</td>
                                                                    <td data-val="{{ $dataMon2['status'] }}"
                                                                        style="text-align: center;">
                                                                        @if ($dataMon2['status'] == 'Sudah')
                                                                            <span
                                                                                style="display:inline-flex; align-items:center; gap:4px; background:#dcfce7; color:#16a34a; padding:4px 10px; border-radius:20px; font-size:10px; font-weight:bold; border:1px solid #86efac; white-space:nowrap;">
                                                                                <i class="fa-solid fa-check"></i>
                                                                                Ditetapkan
                                                                            </span>
                                                                        @else
                                                                            <span
                                                                                style="display:inline-flex; align-items:center; gap:4px; background:#fee2e2; color:#dc2626; padding:4px 10px; border-radius:20px; font-size:10px; font-weight:bold; border:1px solid #fca5a5; white-space:nowrap;">
                                                                    ...
                                                                    <td data-val="{{ $dataMon2['link_sk'] ? 'ada' : '-' }}"
                                                                        style="text-align: center;">
                                                                        @if (!empty($dataMon2['link_sk']))
                                                                            <a href="{{ $dataMon2['link_sk'] }}"
                                                                                target="_blank"
                                                                        ...
                                                                        @else
                                                                            <span
                                                                                style="color:#cbd5e1; font-size:11px;">-</span>
                                                                        @endif
                                                                    </td>
                                                                    <td data-val="{{ $dataMon2['validasi_sk'] ?? '-' }}"
                                                                        style="text-align: center;">
                                                                        ...
                                                                        @elseif (!empty($dataMon2['link_sk']))
                                                                            <span
                                                                                style="display:inline-flex; align-items:center; gap:4px; background:#fefce8; color:#ca8a04; padding:4px 10px; border-radius:20px; font-size:10px; font-weight:bold; border:1px solid #fde68a; white-space:nowrap;">
                                                                        ...
                                                                        <td style="text-align: center;">
                                                                            @if (!empty($dataMon2['link_sk']))
                                                                                <button type="button"
                                                                                    ...
                                                                                    <i
                                                                                        class="fa-solid fa-shield-check"></i>
                                                                                    Validasi SK
                                                                                </button>
                                                                            @else
                                                                                <span
                        ...
                        {{-- ================================================================ --}}
                        @if (in_array($userRole, ['admin', 'panitia']))
                            <div id="modalValidasiSk"
                                style="display:none; position:fixed; inset:0; z-index:9999; background:rgba(15,23,42,0.6); backdrop-filter:blur(4px); align-items:center; justify-content:center; padding:20px;">
                                <div
                                    style="background:#fff; border-radius:20px; box-shadow:0 25px 60px rgba(0,0,0,0.25); width:100%; max-width:520px; overflow:hidden; animation: tabFadeIn 0.3s ease;">

                                    {{-- Header --}}
                                    <div
                                        style="background:linear-gradient(135deg,#6366f1,#4f46e5); padding:20px 25px; display:flex; justify-content:space-between; align-items:center;">
                                        <h3
                                            style="color:#fff; margin:0; font-size:16px; display:flex; align-items:center; gap:10px;">
                                    ...
                                    <div style="padding:25px;">
                                        <div
                                            style="background:#f8fafc; border-radius:12px; padding:16px; margin-bottom:20px; border:1px solid #e2e8f0;">
                                            <div
                                                style="font-size:11px; color:#64748b; font-weight:600; text-transform:uppercase; letter-spacing:0.5px; margin-bottom:4px;">
                                                Satuan Kerja</div>
                                            <div id="popup-sk-satker"
                                                style="font-size:14px; font-weight:700; color:#1e293b;"></div>
                                            <div
                                                style="font-size:11px; color:#64748b; font-weight:600; text-transform:uppercase; letter-spacing:0.5px; margin-top:12px; margin-bottom:4px;">
                                                Nama Kandidat</div>
                                            <div id="popup-sk-nama"
                                                style="font-size:14px; font-weight:700; color:#334155;"></div>
                                        </div>

                                        <div style="margin-bottom:20px;">
                                            <div
                                                style="font-size:12px; color:#64748b; font-weight:600; margin-bottom:8px;">
                                                <i class="fa-solid fa-file-pdf"></i> Dokumen SK
                                            </div>
                                        ...
                                        <div id="popup-sk-status-box" style="text-align:center; margin-bottom:20px;">
                                        </div>

                                        {{-- Form Aksi --}}
                                        <form id="form-validasi-sk-popup" action="{{ route('ist.validasiSk') }}"
                                            method="POST">
                                            @csrf
                            ...
                            <div id="modalConfirmSk"
                                style="display:none; position:fixed; inset:0; z-index:10000; background:rgba(15,23,42,0.6); backdrop-filter:blur(4px); align-items:center; justify-content:center; padding:20px;">
                                <div
                                    style="background:#fff; border-radius:20px; box-shadow:0 25px 60px rgba(0,0,0,0.25); width:100%; max-width:400px; overflow:hidden; animation: tabFadeIn 0.3s ease;">
                                    <div
                                        style="background:linear-gradient(135deg,#f97316,#ea580c); padding:20px 25px; display:flex; justify-content:space-between; align-items:center;">
                                        <h3
                                            style="color:#fff; margin:0; font-size:16px; display:flex; align-items:center; gap:10px;">
                                            <i class="fa-solid fa-circle-question"></i> Konfirmasi Aksi
                                        </h3>
                                        <button type="button"
                                            onclick="document.getElementById('modalConfirmSk').style.display='none'"
                                            style="background:rgba(255,255,255,0.2); border:none; color:#fff; width:32px; height:32px; border-radius:50%; font-size:18px; cursor:pointer; display:flex; align-items:center; justify-content:center; line-height:1;">&times;</button>
                                    </div>
                                    <div style="padding:25px; text-align:center;">
                                        <p id="teks-konfirmasi-sk"
                                            style="font-size:14px; color:#334155; margin-bottom:20px; font-weight:500;">
                                        </p>
                                    ...
                                    <table class="ist-table">
                                        ...
                                        <tbody>
                                            @forelse($rekapVoting as $index => $rv)
                                                <tr
                                                    style="{{ $index === 0 ? 'background: #fffbeb;' : ($index < 3 ? 'background: #f8fafc;' : '') }}">
                                                    <td
                            ...
                            <div class="ist-info-box" style="margin-top: 25px;">
                                ...
                                @if ($kandidatTerpilih)
                                    ...
                                    <div class="ist-winner-card">
                                        ...
                                        {{-- ============================================================ --}}
                                        <div
                                            style="margin-top: 25px; padding: 20px; background: rgba(255,255,255,0.85); border-radius: 14px; border: 1px solid rgba(255,255,255,0.9); backdrop-filter: blur(6px); position: relative; z-index: 5; text-align: left;">

                                            @if ($kandidatTerpilih->validasi_sk === 'tervalidasi')
                                                {{-- ✅ SK SUDAH TERVALIDASI --}}
                                                <div style="text-align: center;">
                                                    <span
                                                        style="display: inline-flex; align-items: center; gap: 8px; background: #dcfce7; color: #16a34a; padding: 10px 22px; border-radius: 30px; font-size: 13px; font-weight: 700; border: 1px solid #86efac;">
                                                        <i class="fa-solid fa-circle-check"></i> SK Penetapan
                                                        Tervalidasi
                                                    </span>
                                                    <br><br>
                                            ...
                                            @elseif ($kandidatTerpilih->validasi_sk === 'ditolak')
                                                ...
                                                <div style="text-align: center; margin-bottom: 15px;">
                                                    <span
                                                        style="display: inline-flex; align-items: center; gap: 8px; background: #fee2e2; color: #dc2626; padding: 10px 22px; border-radius: 30px; font-size: 13px; font-weight: 700; border: 1px solid #fca5a5;">
                                                        <i class="fa-solid fa-circle-xmark"></i> Dokumen SK Ditolak
                                                        Panitia
                                                    </span>
                                                    <p
                                                        style="font-size: 12px; color: #dc2626; margin-top: 8px; font-weight: 500;">
                                                ...
                                                <form action="{{ route('ist.uploadSk') }}" method="POST"
                                                    ...
                                                    <input type="url" name="link_sk" class="input-form"
                                                        ...
                                                        style="flex: 1; min-width: 200px; font-size: 12px; border-color:#fca5a5;"
                                                        value="{{ $kandidatTerpilih->link_sk }}">
                                                    <button type="submit"
                                                        style="background: #f79039; color:#fff; border:none; padding: 10px 18px; border-radius: 8px; font-size: 12px; font-weight: 700; cursor: pointer; white-space: nowrap;">
                                            ...
                                            @elseif (!empty($kandidatTerpilih->link_sk))
                                                ...
                                                <div style="text-align: center; margin-bottom: 15px;">
                                                    <span
                                                        style="display: inline-flex; align-items: center; gap: 8px; background: #fefce8; color: #ca8a04; padding: 10px 22px; border-radius: 30px; font-size: 13px; font-weight: 700; border: 1px solid #fde68a;">
                                                ...
                                                <details style="margin-top: 15px;">
                                                    <summary
                                                        style="cursor: pointer; font-size: 12px; color: #64748b; font-weight: 600;">
                                                        <i class="fa-solid fa-pen"></i> Ganti Link SK
                                                    </summary>
                                                    <form action="{{ route('ist.uploadSk') }}" method="POST"
                                                        style="margin-top: 10px; display: flex; gap: 8px; flex-wrap: wrap;">
                                                        @csrf
                                            ...
                                            @else
                                                {{-- 📂 SK BELUM DIUPLOAD --}}
                                                <h5
                                                    style="color: #1e293b; font-size: 14px; font-weight: 700; margin-bottom: 12px;">
                                                    <i class="fa-solid fa-file-signature"></i> Upload SK Penetapan
                                                </h5>
                                                <p style="font-size: 12px; color: #64748b; margin-bottom: 12px;">
                                                    Silakan buat SK Penetapan menggunakan template di bawah, lalu upload
                                                    dalam format PDF ke Google Drive dan masukkan linknya.
                                                </p>
                                                <div style="text-align: center; margin-bottom: 15px;">
                                                    <a href="https://docs.google.com/document/d/185XHLeBfRZH5xia61ADolSLtKZRpQFOS/edit?usp=sharing&ouid=113779814476523304511&rtpof=true&sd=true"
                                                        target="_blank"
                                                ...
                                                @forelse($rekapVoting as $index => $rv)
                                                    <tr
                                                        ...
                                                        <td style="text-align: center;">
                                                            ...
                                                            @else
                                                                <span style="color: #cbd5e1; font-size: 12px;"><i
                    ...
                    @if ($activeStep >= 5 && $periode && $periode->is_active)
                        ...
                        @if ($isAdmin || $userRole == 'panitia')
                            <div class="ist-info-box" style="border-left-color: #10b981;">
                                <div class="ist-info-header"
                            ...
                            {{-- ======================================================== --}}
                            {{-- TAMPILAN PENGUMPULAN KHUSUS KANDIDAT TAHAP 2             --}}
                            {{-- ======================================================== --}}
                        ...
                        @else
                            ...
                            <div class="ist-info-box"
                                ...
                                <div
                                    style="text-align: center; margin-bottom: 25px; padding-bottom: 20px; border-bottom: 2px dashed #e2e8f0;">
                                    <h2 style="color: #16a34a; margin-bottom: 10px; font-size: 24px;">
                                        <i class="fa-solid fa-bullhorn fa-shake" style="color: #f79039;"></i>
                                        Pengumuman Hasil Penilaian Tahap 1
                                    </h2>
                                    <p style="color: #475569; font-size: 15px; max-width: 700px; margin: 0 auto;">
                                        Selamat kepada para pegawai teladan berikut yang telah resmi ditetapkan
                                        sebagai
                                        perwakilan dari masing-masing Satuan Kerja untuk melaju ke Tahap 2 (Tingkat
                                        Provinsi).
                                    </p>
            ...
            {{-- MODAL MANAJEMEN BERKAS ADMIN --}}
            @if ($isAdmin)
                <div id="modalBerkasAdmin" class="modal-overlay" style="display: none;">
                    <div class="modal-content" style="max-width: 700px;">
                        <div class="modal-header">
                            <h3>Manajemen Dokumen Provinsi</h3>
                            <span class="tutup-modal" onclick="tutupModalBerkasAdmin()">×</span>
                        </div>
                        <div class="modal-body">
                            {{-- Tabel Daftar Berkas untuk Admin --}}
                            <div class="ist-table-responsive" style="margin-bottom: 20px;">
                                <table class="ist-table">
                                    <thead>
                                        <tr>
                                            <th>Urutan</th>
                                    ...
                                    <tbody>
                                        @foreach ($daftarBerkas ?? [] as $b)
                                            <tr>
                                                <td>{{ $b->urutan }}</td>
                                                <td>{{ $b->nama_dokumen }}</td>
                                                <td>
                                                    <button type="button" class="btn-hapus-baris"
                                                        onclick="editBerkasAdmin({{ $b->id }}, '{{ $b->urutan }}', '{{ addslashes($b->nama_dokumen) }}', '{{ addslashes($b->keterangan) }}', '{{ $b->link_template }}')"><i
                                                            class="fa-solid fa-pen"></i></button>
                                                    <form action="{{ route('ist.hapusBerkas', $b->id) }}"
                                                        method="POST" style="display:inline;"
                                                        onsubmit="return confirm('Hapus dokumen ini?')">
                                                        @csrf @method('DELETE')
                                                        <button type="submit" class="btn-hapus-baris"><i
                            ...
                            <form action="{{ route('ist.storeBerkas') }}" method="POST" id="formBerkasAdmin">
                                @csrf
                                <input type="hidden" name="periode_id" value="{{ $periode->id ?? '' }}">
                                <input type="hidden" name="berkas_id" id="input_berkas_id">

                                <div class="grup-input"
                                    style="display: grid; grid-template-columns: 1fr 4fr; gap: 15px;">
                                    <div>
                                        <label>No. Urut</label>
                                        <input type="number" name="urutan" id="input_urutan"
                                            class="input-form" value="1" required>
                                    </div>
                                    <div>
                                        <label>Nama Dokumen</label>
                                        <input type="text" name="nama_dokumen" id="input_nama_dokumen"
                                            class="input-form" placeholder="Cth: Video Profil / Bukti Dukung"
                                            required>
                                    </div>
                                </div>
                                <div class="grup-input">
                                    <label>Link Template (Google Drive) - Opsional</label>
                                    <input type="url" name="link_template" id="input_link_template"
                                        class="input-form" placeholder="https://drive.google.com/...">
                                </div>
                                <div class="grup-input">
                                    <label>Keterangan / Instruksi</label>
                                    <textarea name="keterangan" id="input_keterangan" class="input-form" rows="2"
                                        placeholder="Panduan untuk kandidat..."></textarea>
                                </div>

                                <div class="modal-footer">
                                    <button type="button" class="ist-btn-secondary" onclick="resetFormBerkas()"
                                        style="padding: 10px 20px; border-radius: 8px; border: 1px solid #ccc; background: #fff; cursor: pointer;">Reset
                                        Form</button>
                                    <button type="submit" class="btn-simpan" id="btnSubmitBerkas">Simpan
                                        Dokumen</button>
                                </div>
                            </form>
                        </div>
            ...
            {{-- MODAL SUBMIT BERKAS KANDIDAT --}}
            @if (isset($isKandidatTahap2) && $isKandidatTahap2)
                <div id="modalSubmitBerkas" class="modal-overlay" style="display: none;">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h3>Kumpulkan Link Berkas</h3>
                            <span class="tutup-modal" onclick="tutupModalSubmitBerkas()">×</span>
                        </div>
                        <div class="modal-body">
                            <form action="{{ route('ist.submitBerkas') }}" method="POST">
                                @csrf
                                <input type="hidden" name="periode_id" value="{{ $periode->id ?? '' }}">
                                <input type="hidden" name="berkas_id" id="submit_berkas_id">
                                <input type="hidden" name="nip_kandidat" value="{{ $userNip }}">

                                <div class="grup-input">
                                    <label>Nama Dokumen</label>
                                    <input type="text" id="submit_nama_dokumen" class="input-form" disabled
                                        style="background: #f3f4f6; font-weight: bold;">
                                </div>
                                <div class="grup-input">
                                    <label>Link URL Berkas Anda (Wajib)</label>
                                    <input type="url" name="link_berkas" id="submit_link_berkas"
                                        class="input-form" placeholder="https://drive.google.com/..." required>
                                    <small style="color: #6b7280; font-size: 0.8rem;">* Pastikan link
                                        Google
                                        Drive Anda disetting "Anyone with the link can view"</small>
                                </div>
                                <div class="grup-input">
                                    <label>Catatan Tambahan (Opsional)</label>
                                    <textarea name="catatan" id="submit_catatan" class="input-form" rows="2"
                                        placeholder="Tambahkan catatan jika perlu..."></textarea>
                                </div>

                                <div class="modal-footer">
                                    <button type="submit" class="btn-simpan">Kirim Berkas</button>
                                </div>
                            </form>
                        </div>
                    </div>
